...
import socorrolib.database.transaction_executor
from socorrolib.database.transaction_executor import (
  TransactionExecutor, TransactionExecutorWithInfiniteBackoff)
from socorrolib.external.postgresql.connection_context import ConnectionContext
...
class TestTransactionExecutor(TestCase):
    ...
    def test_operation_error_with_postgres_with_backoff(self):
        ...
        with config_manager.context() as config:
            ...
            _orig_sleep = socorrolib.database.transaction_executor.time.sleep
            socorrolib.database.transaction_executor.time.sleep = mock_sleep
            ...
            try:
                ...
                socorrolib.database.transaction_executor.time.sleep = _orig_sleep
